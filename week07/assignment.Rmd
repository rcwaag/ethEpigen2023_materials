...
In the same ATAC data on chr19, plot the insertion (i.e. cuts) profiles of nucleosome-free and nucleosome-containing fragments, around the high confidence motifs of two factors
...
#all nucleosome fragments:
#create track of cuts/insertion sites at each position using all nucleosome fragments (I decided to use 500 as a max. fragment length)
bam2bw(bam, output_bw = "nuc_cuts.bw", paired=TRUE, binWidth=1L, minFragLength=140, maxFragLength=500, type="ends", shift=c(4L,-5L), forceSeqlevelsStyle = "Ensembl")

#read tracks into new object
tracks_cut <- c("Insertion profile nucleosome-free fragments"="NF_cuts.bw", "Insertion profile of nucleosome-containing fragments"="nuc_cuts.bw")
